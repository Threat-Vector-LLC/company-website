/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: fea6f2b52c7d7b5d5d69eda4bab5e3cd)
...
declare namespace Cloudflare {
	interface Env {
		...
		WORKER_SELF_REFERENCE: Fetcher /* threat-vector-io-worker */;
		ASSETS: Fetcher;
	}
}
